...
public class AttributeElement extends Element {
	 ...
	 * 
	 * @see
	 * org.ebayopensource.turmeric.tools.annoparser.dataobjects.Element#toString
	 * ()
	 */
	@Override
	public String toString() {
		...
		if (super.getComment() != null) {
			...
			retVal.append("Before Attribute : "
					+ super.getComment().getPreviousComment() + "\n");
			retVal.append("After Attribute : "
					+ super.getComment().getNextComment() + "\n");
		}
