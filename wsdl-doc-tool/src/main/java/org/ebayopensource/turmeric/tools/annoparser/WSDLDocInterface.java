...
/**
 * The implementation WSDLDocInterface must hold data from the parsed wsdl
 * document, as required by the output formatters.
 * 
 * @author srengarajan
 */
public interface WSDLDocInterface extends XSDDocInterface {
	...
	/**
	 * Gets the package name of the WSDL. Package name is the local part of the
	 * WSDL Service URL.
	 * 
	...
	/**
	 * Gets the annotations on the WSDL. Typically returns the annotation
	 * defined on the service element.
	 * 
