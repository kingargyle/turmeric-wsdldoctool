...
public class XSDParserTest {
	...
	public void setUp() throws Exception {
		this.xsdPath = this.getClass().getClassLoader()
	...
	/**
	 * Test method for
	 * {@link org.ebayopensource.turmeric.tools.annoparser.parser.impl.XSDParserImpl#parse(java.lang.String)}
	 * .
	 * 
	 * @throws Exception
	 *             the exception
	...
	public void testParse() throws Exception {
		...
		try {
			...
			assertEquals("Expected elements not found", 339, noOfElements,
					delta);
			System.out.println("no. of elements"
					+ intf.getAllIndependentElements().size());
		} catch (Throwable e) {
