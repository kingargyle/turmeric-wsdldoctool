...
public class DriverTest extends TestCase {
	...
	public void testDriver() {
		...
		Driver driver = new Driver(tempDir, null,
				"sampleWsdl/AddressVerificationService(1.0.0).wsdl", null);
		driver.process();
	...
	//
	// Driver driver=new
	// Driver(null,getFilepathFromTestConfigFolder("ConfigurationWithAllProps"),(String)null,null);
	// driver.process();
	// }
	...
	// }
	// Driver driver=new
	// Driver("C:\\annoParser\\Documents",null,documents,null);
	// driver.process();
	// }
	//
	/**
