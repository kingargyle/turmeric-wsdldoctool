...
/**
 * Captures the wsdl operation with its name documentation,
 * input part elements, output part elements.
 *
 * @author sdaripelli
 */
public class OperationHolder implements Comparable<OperationHolder> {
	 ...
	 * Adds the input.
	 *
	 * @param input adding input element to the collection
	 */
	 ...
	 * Adds the output.
	 *
	 * @param output element to the collection
	 */
	 ...
	 * Sets the input.
	 *
	 * @param inputs utility for setting the entire collection of input parts
	 */
	 ...
	 * Sets the output.
	 *
	 * @param outputs utility for setting the entire collection of output parts
	 */
