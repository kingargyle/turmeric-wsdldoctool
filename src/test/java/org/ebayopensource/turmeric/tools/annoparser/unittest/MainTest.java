...
public class MainTest  extends TestCase{
	...
	public void testMain() {
		String [] args=new String[]{"documents="+"sampleWsdl/AddressVerificationService(1.0.0).wsdl","output_dir=C:\\annoParser\\Documents"};
		try {
			Main.main(args);
...
//		String [] args=new String[]{"config="+getFilepathFromTestConfigFolder("ConfigurationWithAllProps")};
//		try {
//			Main.main(args);
//		} catch (WsdlDocException e) {
//			fail(e.getMessage());
...
//		}
//		String [] args=new String[]{"documents="+documents,"output_dir=C:\\annpParser\\Documents"};
//		try {
//			Main.main(args);
//		} catch (WsdlDocException e) {
//			fail(e.getMessage());
...
@Test
	...
	{
		String [] args=new String[]{"documents="+"sampleWsdl/sample.xsd","output_dir=C:\\temp\\"};
		try {
			Main.main(args);
		} catch (Exception e) {
	...
	{
		String [] args=new String[]{"documents="+"sampleWsdl/sample_invalid.xsd","output_dir=C:\\temp\\"};
		try {
			Main.main(args);
		} catch (Exception e) {
			System.out.println(e.getMessage());
	...
	{
		String [] args=new String[]{"documents="+"sampleWsdl/sample_invalid_extension.xsd1","output_dir=C:\\temp\\"};
		try {
			Main.main(args);
		} catch (Exception e) {
			System.out.println(e.getMessage());
	...
	{
		String [] args=new String[]{"config="+getFilepathFromTestConfigFolder("ConfigurationWithInvalidOpGenerator.xml")};
		try {
			Main.main(args);
		} catch (Exception e) {
			System.out.println(e.getMessage());
	...
	{
		String [] args=new String[]{"config="+getFilepathFromTestConfigFolder("test.xml")};
		try {
			Main.main(args);
		} catch (Exception e) {
			System.out.println(e.getMessage());
	...
	public void testMainWithHelpArg() {
		String [] args=new String[]{"documents="+"sampleWsdl/AddressVerificationService(1.0.0).wsdl","output_dir=C:\\annpParser\\Documents",Constants.COMMAND_LINE_HELP_ARG};
		try {
			Main.main(args);
		} catch (Exception e) {
			System.out.println(e.getMessage());
	...
	public void testMainWithNoDocValue() {
		String [] args=new String[]{"documents","output_dir=C:\\annpParser\\Documents",Constants.COMMAND_LINE_HELP_ARG};
		try {
			Main.main(args);
		} catch (Exception e) {
			System.out.println(e.getMessage());
	...
	{
		String [] args=new String[]{"config="+getFilepathFromTestConfigFolder("ConfigurationWithAbstractClassAsOpGen.xml")};
		try {
			Main.main(args);
		} catch (Exception e) {
	...
	{
		String [] args=new String[]{"config="+getFilepathFromTestConfigFolder("ConfigFileWithInvalidAnnoParser.xml")};
		try {
			Main.main(args);
		} catch (Exception e) {
	...
	{
		String [] args=new String[]{"config="+getFilepathFromTestConfigFolder("ConfigFileWithAbstractAnnoParser.xml")};
		try {
			Main.main(args);
		} catch (Exception e) {
			System.out.println(e.getMessage());
	...
	{
		String [] args=new String[]{"config="+getFilepathFromTestConfigFolder("Configuration_invalid.xml")};
		try {
			Main.main(args);
		} catch (Exception e) {
			System.out.println(e.getMessage());
